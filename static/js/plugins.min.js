      ...
      , w = function() {
        ...
        (t = [{
            ...
            value: function(e) {
                ...
                t.isElementInViewport = 0 <= r.bottom && 0 <= r.right && r.top <= h && r.left <= b.window.innerWidth,
                e || t.isElementInViewport) {
                    var l = Math.max(0, o)
                      ...
                      , m = 1 - (h - o) / (h + i) * 2
                      , f = 1;
                    if (i < h ? f = 1 - (c || u) / i : s <= h ? f = s / h : d <= h && (f = d / h),
    ...
    A.fn.stick_in_parent = function(t) {
        ...
        i = function(s, r, n, l, a, c, p, u) {
            ...
            if (!s.data("sticky_kit")) {
                ...
                if (d = f = !1,
                (v = null != P ? P && s.closest(P) : A("<div />")) && v.css("position", s.css("position")),
                (m = function() {
                    var t, i, o;
                    if (!u && (h = w.height(),
                    ...
                    o = !0),
                    a = s.offset().top - (parseInt(s.css("margin-top"), 10) || 0) - V,
                    c = s.outerHeight(!0),
                    p = s.css("float"),
                    v && v.css({
                        width: F(s),
                ...
                c !== l)
                    ...
                    e = function() {
                        ...
                        o < a && (f = !1,
                        k = V,
                        null == P && ("left" !== p && "right" !== p || s.insertAfter(v),
                        v.detach()),
                        t = {
                            position: "",
                            width: "",
                        ...
                        s.css(t).removeClass(I).trigger("sticky_kit:unstick")),
                        x && ((t = M.height()) < c + V && !d && (k -= i,
                        k = Math.max(t - c, k),
                        k = Math.min(V, k),
                        f && s.css({
                            top: k + "px"
                    ...
                    t = function() {
                        ...
                        y.position("position", ""),
                        f)
                            return null == P && ("left" !== p && "right" !== p || s.insertAfter(v),
                            v.remove()),
                            s.removeClass(I)
                    }
                    ,
...
!function(e, n) {
    ...
    e.Scene.extend(function() {
        ...
        r.on("destroy.plugin_anime", function(e) {
            r.off("*.plugin_anime"),
            r.removeAnime(e.reset)
        });
        var t = function() {
            if (n) {
                var e = r.progress();
                e != o && (0 === r.duration() ? e > 0 ? n.play() : ((i = n).play(),
                i.reverse()) : n.seek(n.duration * e),
                o = e)
            }
            var i
        };
        r.setAnime = function(e) {
            return n && r.removeAnime(),
            e.pause(),
            n = e,
...
!function(t) {
    ...
    window.SplitType = function(E, p, l) {
        if (p.addEventListener && Function.prototype.bind) {
            ...
            y.prototype.split = function(t) {
                ...
                B(this.elements, function(t) {
                    (function(t) {
                        var e, i, n, s, l = this.settings, r = l.tagName, o = "B" + +new Date + "R", p = l.split, a = -1 !== p.indexOf("lines"), h = -1 !== p.indexOf("words"), f = -1 !== p.indexOf("chars"), c = "absolute" === l.position || !0 === l.absolute, d = N("div"), u = [], y = [];
                        if (s = a ? N("div") : M(),
                        d.innerHTML = t.innerHTML.replace(/<br\s*\/?>/g, " " + o + " "),
                        e = d.textContent.replace(/\s+/g, " ").trim().split(" ").map(function(t) {
                            if (t === o)
                                return s.appendChild(N("br")),
                                null;
                            if (f) {
                        ...
                        c || a) {
                            ...
                            B(x, function(t) {
                                if (t !== s) {
                                    ...
                                    a && i && ((e = D(t).top = t.offsetTop) !== m && (m = e,
                                    S.push(g = [])),
                                    g.push(t)),
                                    c && (D(t).top = e || t.offsetTop,
                            ...
                            c && (t.style.width = t.style.width || v + "px",
                            t.style.height = w + "px",
                            B(x, function(t) {
                                var e = "line" === D(t).type
                                  , i = !e && "line" === D(t.parentElement).type;
                                t.style.top = i ? 0 : D(t).top + "px",
                                t.style.left = e ? b.left + "px" : (i ? D(t).left - b.left : D(t).left) + "px",
                                t.style.height = D(t).height + "px",
                                t.style.width = e ? b.width + "px" : D(t).width + "px",
                ...
                B(this.elements, function(t) {
                    for (var e, i, n = D(t).nodes || [], s = 0, l = n.length; s < l; s++)
                        (i = (e = n[s]) && e[r]) && (delete e[i],
                        delete o[i])
                })
            }
            ,
            y.prototype.revert = function() {
                ...
                B(this.elements, function(t) {
                    D(t).isSplit && D(t).html && (t.innerHTML = D(t).html,
        ...
        function B(t, e, i) {
            for (var n, s = Object(t), l = d(s) ? s : c(n = s) && "[object Object]" === Object.prototype.toString.call(n) ? h(s) : [s], r = parseInt(l.length) || 0, o = 0; o < r; o++)
                e.call(i, l[o], o, s)
        }
        function n(i, n) {
            return i = Object(i),
        ...
        function y(t, e) {
            ...
            this.elements = function(t) {
                var e, i, n, s, l, r, o = [];
                if ("string" == typeof t && (t = "#" === (e = t.trim())[0] && !/[^\w]/.test(i = e.slice(1)) ? p.getElementById(i) : p.querySelectorAll(e)),
                e || u(t))
...
+function(a) {
    ...
    d.prototype.validateInput = function(c, d) {
        ...
        !f.isDefaultPrevented()) {
            ...
            return this.runValidators(c).done(function(b) {
                ...
                g.$element.trigger(f)),
                g.toggleSubmit(),
                g.$element.trigger(a.Event("validated.bs.validator", {
                    relatedTarget: c[0]
                }))
            })
        }
    ...
    d.prototype.runValidators = function(c) {
        ...
        a.each(this.validators, a.proxy(function(a, d) {
            var e = null;
            !b(c) && !c.attr("required") || void 0 === c.attr("data-" + a) && "native" != a || !(e = d.call(this, c)) || (e = g(a) || e,
            !~h.indexOf(e) && h.push(e))
        }, this)),
        !h.length && b(c) && c.attr("data-remote") ? this.defer(c, function() {
            var d = {};
            d[c.attr("name")] = b(c),
            a.get(c.attr("data-remote"), d).fail(function(a, b, c) {
                h.push(g("remote") || c)
            }).always(function() {
                i.resolve(h)
            })
